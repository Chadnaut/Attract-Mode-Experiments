/**
 * Experiment.SpinBox Layout3
 *
 * @summary A fake 3D spinning box, controlled with the mouse.
...
function on_tick(ttime) {
    local mx = fe.get_input_pos("Mouse Left")
    local my = fe.get_input_pos("Mouse Up")
